		...
		<div class="pb-[40%] mb-[20px]">
			<div class="absolute h-[56.25vw] w-full">
				<div class="absolute inset-0">
					<img class="w-full" src="/images/formula1.webp" alt="billboard"/>
				...
				<div class="absolute inset-0">
					<div class="flex flex-col justify-end absolute top-0 bottom-[35%] left-[4%] 2xl:left-[60px] w-[36%]">
						<div class="w-full">
							<div>
								<img src="/images/formula1text.webp" alt="billboard"/>
							</div>
							...
							<div class="flex mt-[1.5vw]">
								<Button class="bg-white text-black hover:bg-white/75 transition ease-in-out">
									<template #icon>
										<div class="h-10 w-10">
								...
								<Button class="bg-neutral-500/[70%] text-white hover:bg-neutral-500/[40%] transition ease-in-out">
									<template #icon>
										<div class="h-10 w-10">
